...
func get_description() -> String:
	...
	hero_description_text += "Amor: " + str(GlobalVariables.playerArmor)+ "\n"
	hero_description_text += "Block: " + str(GlobalVariables.playerBlock)+ "\n"
	hero_description_text += "Magic Res: " + str(GlobalVariables.playerMagicRes)+ "\n"
